...
final class ConfigStore {
    ...
    func load() -> AIConfig {
        ...
        return AIConfig(host: "", textModel: "", visionModel: "", allowVision: true, allowSummary: true, dailyStepGoal: 8000, targetWeight: nil, dailyCalorieTarget: 1800, appearance: "system")
    }
